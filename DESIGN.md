...
- **Seed color:** `#4F46E5` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
Import tokens via `package:nalbari_connect/src/theme/theme_constants.dart`.
